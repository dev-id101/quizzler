...
class QuizBrain {
  ...
  final List<Question> _questionBank = [
    ...
    Question(q: 'Buzz Aldrin\'s mother\'s name was "Moon".', a: true),
    ...
    Question(
        ...
        a: true),
    Question(
        q: 'In West Virginia, USA, if you accidentally hit an animak with your car, you are free to take it home to eat.',
        a: true),
  ];
